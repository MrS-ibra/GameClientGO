...
void GameLODManager::init(void)
{
	...
	ini.loadFileDirectory( AsciiString( "Data\\INI\\GameLOD.ini" ), INI_LOAD_OVERWRITE, NULL );

	//Get presets for each known hardware configuration
	ini.loadFileDirectory( AsciiString( "Data\\INI\\GameLODPresets.ini"), INI_LOAD_OVERWRITE, NULL);
