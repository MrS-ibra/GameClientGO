...
UnsignedInt DeletionUpdate::calcSleepDelay(UnsignedInt minFrames, UnsignedInt maxFrames)
{
	...
	// render it before DeletionUpdate destroys it, versus ~33ms at the retail 30hz. This caused one frame marker objects
	// (like Frenzy_InvisibleMarker_Level's smoke effect) to intermittently never get drawn. 
